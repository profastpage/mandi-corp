      ...
      <div className="bg-brand-green">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-4 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 bg-white text-brand-green px-5 py-2 rounded-xl text-sm font-bold hover:bg-white/90 transition-colors duration-200"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <Link href="/" className="inline-block mb-4">
              ...
              <br />
              <span className="text-xs font-semibold tracking-[0.2em] uppercase text-blue-400 -mt-1 block">
                El Progreso
              </span>
            </Link>
