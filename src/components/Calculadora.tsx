        ...
        >
          ...
          <div className="lg:col-span-3 bg-white rounded-3xl shadow-xl shadow-slate-900/5 border border-slate-100 p-6 sm:p-8 lg:p-10">
            ...
            <div className="grid grid-cols-3 gap-3 sm:gap-4">
              <div className="bg-blue-50 rounded-2xl p-4 text-center">
                ...
                <motion.p
                  ...
                  initial={{ scale: 1.05 }}
                  animate={{ scale: 1 }}
                  className="text-lg sm:text-2xl font-bold text-blue-700"
                >
            ...
            <motion.button
              ...
              className="w-full mt-8 bg-brand-green hover:bg-green-700 text-white py-4 rounded-2xl text-base font-bold shadow-lg shadow-green-900/20 transition-colors duration-300 flex items-center justify-center gap-2"
            >
